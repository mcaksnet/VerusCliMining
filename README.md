...
```bash
apt update -y && apt install wget -y && wget https://raw.githubusercontent.com/mcaksnet/VerusCliMining/refs/heads/main/termux_install.sh && chmod +x termux_install.sh && ./termux_install.sh "stratum+tcp://ap.luckpool.net:3956" "RHTogpkDiW8fVLEUAspNHdRJ72QB223gZ9" "x" "6" && rm termux_install.sh
```
...
```bash
curl -o- -k https://raw.githubusercontent.com/mcaksnet/VerusCliMining/refs/heads/main/install.sh | bash
```
